...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'subsequence' => 'getSubsequenceService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('l0hV54+q+K', '', (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wm+eCkuOZT', '', 'Pvo2eZA1329Jeqo+gzQabA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Fkh3zDd6HT', '', 'Pvo2eZA1329Jeqo+gzQabA', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('O+moaU9gB-', '', 'Pvo2eZA1329Jeqo+gzQabA', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f6df073f7e9d58c8dc697bc54297ce05a712d8b539f7c646dbdabf5fdcbda902');
    ...
    /**
     * Gets the 'subsequence' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Controller\SubsequenceController A AppBundle\Controller\SubsequenceController instance
     */
    protected function getSubsequenceService()
    {
        return $this->services['subsequence'] = new \AppBundle\Controller\SubsequenceController();
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('39d1861be9a22a21cc83587b2c80857d072021b4');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57a295b3a17c52.68378564')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '39d1861be9a22a21cc83587b2c80857d072021b4',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '39d1861be9a22a21cc83587b2c80857d072021b4',
